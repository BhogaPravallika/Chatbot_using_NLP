...
def main():
    ...
    if choice == 'Home':
        ...
        if not os.path.exists('chat_log.csv'):
            with open('chat_log.csv', 'w', newline='',encoidng='utf-8') as csvfile:
        ...
        st.write("The goal of this project is to showcase that we create a chatbot using python with NLP. The chatbot used Logistic Regression for the model, we used streamlit for the front end. ")
